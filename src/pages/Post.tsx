...
import { Calendar, Clock, ArrowLeft, Edit, FileDown, FileText } from "lucide-react";
          ...
          {isAuthor && (
            <div className="flex gap-2">
              <Button
                variant="outline"
                size="icon"
                onClick={() => saveAsPdf(post.content, post.title)}
              ...
              <Button
                variant="outline"
                size="icon"
                onClick={() => saveAsDoc(post.content, post.title)}
                className="rounded-full border-slate-200 text-slate-600 hover:bg-slate-50"
                title="Save as DOC"
              >
