...
const Write = () => {
  ...
  const goBackOrHome = () => navigate("/blog");
  const handleBack = () => {
    if (hasUnsavedChanges) { setShowExitModal(true); return; }
    goBackOrHome();
  };

  const handleSaveAsPdf = useCallback(() => saveAsPdf(content, title || 'untitled'), [content, title]);
  const handleSaveAsDoc = useCallback(() => saveAsDoc(content, title || 'untitled'), [content, title]);
        ...
        <div className="flex items-center gap-2">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-44">
              ...
              <DropdownMenuItem onClick={handleSaveAsDoc}>
